...
import com.pachong.pachongdemo.model.ImgFenlei;
import com.pachong.pachongdemo.model.ImgHaveUrl;
import com.pachong.pachongdemo.model.LizhiMingyan;
import com.pachong.pachongdemo.service.DownUrlService;
import com.pachong.pachongdemo.service.FenleiService;
import com.pachong.pachongdemo.service.HaveUrlService;
import com.pachong.pachongdemo.service.LizhiService;
import com.pachong.pachongdemo.utils.DownImgTask;
import com.pachong.pachongdemo.utils.GetFoldFileNames;
import com.pachong.pachongdemo.utils.HttpRequest;
import com.pachong.pachongdemo.utils.UrlUtils;
...
public class ImgContrller {
    ...
    public String getImage() {
        List<LizhiMingyan> all = lizhiService.findAll();
        ...
        for (int size = fenleiList.size(), i = 0; i < 2; i++) {
            ...
            for (String str : all) {
                ...
                if (UrlUtils.isNumeric(numberStr)) {
                    ...
                    LizhiMingyan lizhiMingyan = new LizhiMingyan();
//                    lizhiMingyan.setFenlei(fenleiName);
//                    lizhiMingyan.setImgUrl(url);
                    lizhiService.saveAndFlush(lizhiMingyan);
...
//                    cachedThreadPool.execute(new DownImgTask(url));
    ...
    @RequestMapping("only")
    public String only() {
        List<LizhiMingyan> allImgs = lizhiService.findAll();
